...
export default function UserSettingsPage() {
  ...
  const styles = {
    ...
    submitButton: css({
      backgroundColor: token("colors.blue.500"),
      color: "white",
      px: "4",
      py: "2",
    }),
    creditsWrapper: css({ display: "grid", gap: "2", maxWidth: "24rem" }),
    creditsRow: css({ display: "flex", gap: "2" }),
